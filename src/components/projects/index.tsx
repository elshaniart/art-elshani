        ...
        <div className="project-container">
          ...
          <div className="projects-text-container">
            ...
            <p className="project-text">
              This is the Tauto Web Page which I created with React. It features
              a Home Page, About Page, Blog, Services, and Solutions tabs. The
              client portal, through which Tauto's clients will be able to
              submit tickets is currently in the works!
            </p>
        ...
        <div className="project-container">
          ...
          <div className="projects-text-container">
            ...
            <p className="project-text">
              ...
              data displayed on the app (recipes, images, tags), are all fetched
              from Contentful. The routing for the recipes is made
        ...
        <div className="project-container">
          ...
          <div className="projects-text-container">
            ...
            <p className="project-text">
              ...
              from the fake store API. I created this app in order to strengthen
              my understanding of fetching data from an API.
            </p>
            <a
